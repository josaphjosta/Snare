...
from Data_generation_scout import chat4data_all, get_local_time
# from Data_generation_example import chat4data_all, get_local_time

API_KEY = 'sk-7015d98e24c9431f9fb7fb2a4454186e'
output_dict = {}
# output_dict = load_json('./checkpoint.json')
# request_event_list = ['TRANSPORT', 'ATTACK']
...
def fetch_url(thread_id, passages_per_event,
    ...
    while True:
        try:
            ...
            chat = True
            event4chat = event_queue.safe_get(timeout=10)
