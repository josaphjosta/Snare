...
class DataPrompt:
    def __init__(self, event_dict=None, trigger_dict=None, arguments_dict=None, n_event=None, max_argument=None, complex_score=None, minimum_arg_fn = './meta_data/minimum_argument_dict.json', event_chains = './meta_data/event_chains.pkl', role_relations = './meta_data/role_relations.pkl'):
        ...
        self.task_ins = '\nGenerate 1 compliant passage following ALL constraints(output only, and in a tone of professional journalist).'
        self.event_list = []
        self.chain = []
        ...
        try:
            ...
            self.rec_dict = {}
        self.event_chains = util.load_pickle('./meta_data/event_chains.pkl')
        self.role_relations = util.load_pickle('./meta_data/role_relations.pkl')
    ...
    def get_data_prompt(self):
        ...
        event_record_prompt = self.event_definition + self.trigger_details + self.task_requirement + self.complexity_control+ self.event_detail + self.example + self.task
