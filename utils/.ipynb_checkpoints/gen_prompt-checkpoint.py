...
class Prompt:
    def __init__(self, event_dict=None, arguments_dict=None, n_event=None, max_argument=None, complex_score=None, trigger_dict=None):
    ...
    def gen_rec_prompt(self, main_event, update=True, n_event=None, max_argument=None, complex_score=None):
        if update:
            self.data_prompt.update(main_event, n_event, max_argument, complex_score)
        return self.data_prompt.get_check_rec_prompt()
